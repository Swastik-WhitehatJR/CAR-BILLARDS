class Car {
  constructor(isPlayer) {
    ...
    setInterval(() => {
      if (carColour.value === "Not_Selected") {
        this.color = COLORS.white;
      }
      else if (carColour.value === "red") {
        this.color = COLORS.red;
      }
      else if (carColour.value === "dimRed") {
        this.color = COLORS.dimRed;
      }
      else if (carColour.value === "maroon") {
        this.color = COLORS.maroon;
      }
      else if (carColour.value === "orange") {
        this.color = COLORS.orange;
      }
      else if (carColour.value === "yellow") {
        this.color = COLORS.yellow;
      }
      else if (carColour.value === "green") {
        this.color = COLORS.green;
      }
      else if (carColour.value === "purple") {
        this.color = COLORS.purple;
      }
      else if (carColour.value === "blue") {
        this.color = COLORS.blue;
      }
      else if (carColour.value === "white") {
        this.color = COLORS.white;
      }
      else if (carColour.value === "black") {
        this.color = COLORS.black;
      }
      else if (carColour.value === "lightBlack") {
        this.color = COLORS.lightBlack;
      }
      else if (carColour.value === "blueGreen") {
        this.color = COLORS.blueGreen;
      }
      else if (carColour.value === "darkBlueGreen") {
        this.color = COLORS.darkBlueGreen;
      }
      else if (carColour.value === "tableWood") {
        this.color = COLORS.tableWood;
      }
      else if (carColour.value === "pink") {
  ...
  render() {
    if (playerName.value != "" && enemyName.value != "") {
      ...
      const label = this.isPlayer ? playerName.value : enemyName.value;
